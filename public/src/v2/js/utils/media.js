...
export const landscapeOnlyMediaQuery = `(min-width: ${LANDSCAPE_VIEWPORT_MIN}px) and (max-width: ${
  LANDSCAPE_VIEWPORT_MIN - 1
}px)`;

export const tabletMinMediaQuery = `(min-width: ${TABLET_VIEWPORT_MIN}px)`;

export const tabletOnlyMediaQuery = `(min-width: ${TABLET_VIEWPORT_MIN}px) and (max-width: ${
  DESKTOP_VIEWPORT_MIN - 1
}px)`;
